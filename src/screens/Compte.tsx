...
const PLANS: {
  ...
  },
  {
    ...
    features: ['Tout Essentiel', 'Carte interactive', 'Pipeline chantiers', 'France entière', 'Photos', 'Génération de devis IA'],
    color: 'text-green',
    icon: Star,
  },
  {
    ...
    features: ['Tout Pro', 'Facturation légale complète', 'Dashboard financier'],
    color: 'text-purple',
    icon: Building2,
  },
]
